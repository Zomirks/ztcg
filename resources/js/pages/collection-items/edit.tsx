...
import type { CollectionItem, CollectionItemFormData, Product, ProductConditionEnum, Tcg } from '@/types/models';
...
export default function Edit({ collection_item, products, productConditions, tcgs }: Props) {
